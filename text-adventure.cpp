    ...
    do {
      ...
      if (choice == 1 || choice == 2) {
        if (branch == "A") {
          ...
          if (choice == 1) {
            std::cout << "YOU DIED THE FIRST OF MANY HORRIBLE DEATHS!!!\n\n";
            lifes--;
            path += " - END1";
          ...
          if (choice == 1)
            ...
            std::cout << "YOU DIED THE SECOND OF MANY HORRIBLE DEATHS!!!\n\n";
            lifes--;
            path += " - END2";
          ...
          if (choice == 1) {
            std::cout << "YOU DIED THE THIRD OF MANY HORRIBLE DEATHS!!!\n\n";
            lifes--;
            path += " - END3";
          ...
          if (choice == 1) {
            std::cout << "YOU DIED THE FIFTH OF MANY HORRIBLE DEATHS!!!\n\n";
            lifes--;
            path += " - END5";
            ...
            std::cout << "YOU DIED THE FOURTH OF MANY HORRIBLE DEATHS!!!\n\n";
            lifes--;
            path += " - END4";
...
*/
  ...
  std::cout << "YOU HAVE REACHED THE END ALIVE!!!\n";
